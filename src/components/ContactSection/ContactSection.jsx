            ...
            <div className={styles.info}>
              ...
              <div className={styles.infoCard}>
                ...
                <div className={styles.cardBody}>
                  ...
                  <a className={styles.cardValue} href="mailto:info@monshaatech.com">
              ...
              <div className={styles.infoCard}>
                ...
                <div className={styles.cardBody}>
                  ...
                  <a className={`${styles.cardValue} ${styles.ltr}`} href="tel:+966562721190">
                    +966 56 272 1190
                  </a>
                </div>
              </div>
              ...
              <div className={styles.infoCard}>
                ...
                <div className={styles.cardBody}>
                  ...
                  <div className={styles.cardValue}>{t.contact.locationVal}</div>
                </div>
              </div>
            </div>
          </div>
